...
public class RabbitMQConfig {
    ...
    @Bean(name = RabbitConstant.RABBIT_TEMPLATE_BEAN)
    ...
    Queue replyQueue() {
        return new Queue(rabbitmqProperties.getProperty(RabbitConstant.REPLY_QUEUE), true);
    }

    @Bean(name = "rabbitExchange")
    DirectExchange exchange() {
        return new DirectExchange(rabbitmqProperties.getProperty(RabbitConstant.EXCHANGE));
    }
